...
export const translations = {
  en: {
    ...
    closing: 'Closing...',
    confirmCloseAll: 'Are you sure you want to close all positions for {traderName}? This action cannot be undone!',
    closeSuccess: 'Positions closed successfully!',
    closeFailed: 'Failed to close positions: {error}',
  ...
  zh: {
    ...
    closing: '平仓中...',
    confirmCloseAll: '确定要平掉 {traderName} 的所有持仓吗？此操作不可撤销！',
    closeSuccess: '平仓成功！',
    closeFailed: '平仓失败：{error}',
